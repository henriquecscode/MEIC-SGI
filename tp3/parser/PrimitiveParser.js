...
import { liddedCylinderParser } from './primitivesParser/LiddedCylinderParser.js';
    ...
    for (var i = 0; i < children.length; i++) {
        ...
        if (grandChildren.length != 1 ||
            (grandChildren[0].nodeName != 'rectangle' && grandChildren[0].nodeName != 'triangle' &&
                ...
                grandChildren[0].nodeName != 'torus' && grandChildren[0].nodeName != 'patch' && grandChildren[0].nodeName != 'liddedCylinder')) {
            return "There must be exactly 1 primitive type (rectangle, triangle, cylinder, sphere, torus, patch or liddedCylinder)"
        }
        ...
        } else if (primitiveType == 'liddedCylinder') {
            var value = liddedCylinderParser.call(this, grandChildren, primitiveId);
        }
        else {
