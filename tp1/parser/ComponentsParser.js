...
export function componentsParser(componentsNode) {
    ...
    for (var i = 0; i < children.length; i++) {
        ...
        var texture;
        if (textureIndex == -1) {
            return "Texture is mandatory. Missing <texture> tag for " + componentID;
        }
        else {
        ...
        this.components[componentID] = new Component(componentID, this, transformation, materials, texture);
